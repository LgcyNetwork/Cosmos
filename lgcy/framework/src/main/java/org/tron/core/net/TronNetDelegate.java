...
public class TronNetDelegate {
  ...
  public boolean contain(Sha256Hash hash, MessageTypes type) {
    ...
    } else if (type.equals(MessageTypes.USDL)) {
  ...
  public void pushTransaction(TransactionCapsule usdl) throws P2pException {
    try {
      ...
      throw new P2pException(TypeEnum.BAD_USDL, e);
      ...
      throw new P2pException(TypeEnum.USDL_EXE_FAILED, e);
    }
  }

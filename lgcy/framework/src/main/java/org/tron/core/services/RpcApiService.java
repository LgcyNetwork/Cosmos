...
public class RpcApiService implements Service {
  ...
  private void callContract(TriggerSmartContract request,
    ...
    try {
      TransactionCapsule usdlCap = createTransactionCapsule(request,
          ContractType.TriggerSmartContract);
      Transaction usdl;
      if (isConstant) {
        usdl = wallet.triggerConstantContract(request, usdlCap, usdlExtBuilder, retBuilder);
      } else {
        usdl = wallet.triggerContract(request, usdlCap, usdlExtBuilder, retBuilder);
      }
      ...
      responseObserver.onNext(usdlExtBuilder.build());
  ...
  private TransactionExtention transaction2Extention(Transaction transaction) {
    ...
    TransactionExtention.Builder usdlExtBuilder = TransactionExtention.newBuilder();
    Return.Builder retBuilder = Return.newBuilder();
    usdlExtBuilder.setTransaction(transaction);
    usdlExtBuilder.setTxid(Sha256Hash.of(CommonParameter.getInstance()
  ...
  public class WalletApi extends WalletImplBase {
    ...
    private void createTransactionExtention(Message request, ContractType contractType,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule usdl = createTransactionCapsule(request, contractType);
        usdlExtBuilder.setTransaction(usdl.getInstance());
        usdlExtBuilder.setTxid(usdl.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (ContractValidateException e) {
        retBuilder.setResult(false).setCode(response_code.CONTRACT_VALIDATE_ERROR)
    ...
    public void getTransactionSign2(TransactionSign req,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule usdl = TransactionUtil.getTransactionSign(req);
        usdlExtBuilder.setTransaction(usdl.getInstance());
        usdlExtBuilder.setTxid(usdl.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (Exception e) {
    ...
    public void addSign(TransactionSign req,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule usdl = transactionUtil.addSign(req);
        usdlExtBuilder.setTransaction(usdl.getInstance());
        usdlExtBuilder.setTxid(usdl.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (Exception e) {
    ...
    @Override
    public void updateKandyLimit(UpdateKandyLimitContract request,
        StreamObserver<TransactionExtention> responseObserver) {
      createTransactionExtention(request, ContractType.UpdateKandyLimitContract,
          responseObserver);
    }
    ...
    public void createShieldedTransaction(PrivateParameters request,
      ...
      try {
        ...
        TransactionCapsule usdl = wallet.createShieldedTransaction(request);
        usdlExtBuilder.setTransaction(usdl.getInstance());
        usdlExtBuilder.setTxid(usdl.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
    ...
    public void createShieldedTransactionWithoutSpendAuthSig(PrivateParametersWithoutAsk request,
      ...
      try {
        ...
        TransactionCapsule usdl = wallet.createShieldedTransactionWithoutSpendAuthSig(request);
        usdlExtBuilder.setTransaction(usdl.getInstance());
        usdlExtBuilder.setTxid(usdl.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (ContractValidateException | ZksnarkException e) {

...
public class Args extends CommonParameter {
  ...
  public static void clearParam() {
    ...
    PARAMETER.allowAdaptiveKandy = 0;
    PARAMETER.allowLvmTransferTrc10 = 0;
    PARAMETER.allowLvmConstantinople = 0;
    PARAMETER.allowDelegateResource = 0;
    PARAMETER.allowSameTokenName = 0;
    PARAMETER.allowLvmSolidity059 = 0;
    ...
    PARAMETER.usdlExpirationTimeInMilliseconds = 0;
    ...
    PARAMETER.allowLvmIstanbul = 0;
    PARAMETER.allowLvmStake = 0;
    PARAMETER.allowLvmAssetIssue = 0;
  }
  ...
  public static void setParam(final String[] args, final String confFileName) {
    ...
    PARAMETER.netMaxUSDLPerSecond = config.hasPath(Constant.NODE_NET_MAX_USDL_PER_SECOND)
        ? config.getInt(Constant.NODE_NET_MAX_USDL_PER_SECOND)
        : NetConstants.NET_MAX_USDL_PER_SECOND;
    ...
    PARAMETER.allowAdaptiveKandy =
        config.hasPath(Constant.COMMITTEE_ALLOW_ADAPTIVE_KANDY) ? config
            .getInt(Constant.COMMITTEE_ALLOW_ADAPTIVE_KANDY) : 0;
    ...
    PARAMETER.allowLvmTransferTrc10 =
        config.hasPath(Constant.COMMITTEE_ALLOW_LVM_TRANSFER_TRC10) ? config
            .getInt(Constant.COMMITTEE_ALLOW_LVM_TRANSFER_TRC10) : 0;

    PARAMETER.allowLvmConstantinople =
        config.hasPath(Constant.COMMITTEE_ALLOW_LVM_CONSTANTINOPLE) ? config
            .getInt(Constant.COMMITTEE_ALLOW_LVM_CONSTANTINOPLE) : 0;

    PARAMETER.allowLvmSolidity059 =
        config.hasPath(Constant.COMMITTEE_ALLOW_LVM_SOLIDITY059) ? config
            .getInt(Constant.COMMITTEE_ALLOW_LVM_SOLIDITY059) : 0;
    ...
    PARAMETER.needToUpdateAsset =
        config.hasPath(Constant.STORAGE_NEEDTO_UPDATE_ASSET) ? config
            ...
            : true;
    PARAMETER.usdlReferenceBlock = config.hasPath(Constant.USDL_REFERENCE_BLOCK)
        ? config.getString(Constant.USDL_REFERENCE_BLOCK) : "head";

    PARAMETER.usdlExpirationTimeInMilliseconds =
        config.hasPath(Constant.USDL_EXPIRATION_TIME_IN_MILLIS_SECONDS)
            && config.getLong(Constant.USDL_EXPIRATION_TIME_IN_MILLIS_SECONDS) > 0
            ? config.getLong(Constant.USDL_EXPIRATION_TIME_IN_MILLIS_SECONDS)
    ...
    PARAMETER.blockNumForKandyLimit = config.hasPath(Constant.KANDY_LIMIT_BLOCK_NUM)
        ? config.getInt(Constant.KANDY_LIMIT_BLOCK_NUM) : 4727890L;
    ...
    PARAMETER.allowLvmIstanbul =
        config.hasPath(Constant.COMMITTEE_ALLOW_LVM_ISTANBUL) ? config
            .getInt(Constant.COMMITTEE_ALLOW_LVM_ISTANBUL) : 0;
    ...
    PARAMETER.allowLvmStake =
            config.hasPath(Constant.COMMITTEE_ALLOW_LVM_STAKE) ? config
                    .getInt(Constant.COMMITTEE_ALLOW_LVM_STAKE) : 0;

    PARAMETER.allowLvmAssetIssue =
            config.hasPath(Constant.COMMITTEE_ALLOW_LVM_ASSETISSUE) ? config
                    .getInt(Constant.COMMITTEE_ALLOW_LVM_ASSETISSUE) : 0;

  ...
  public static boolean process(Manager manager, ProposalCapsule proposalCapsule) {
    ...
    for (Map.Entry<Long, Long> entry : map.entrySet()) {
      ...
      switch (proposalType) {
        ...
        case KANDY_FEE: {
          manager.getDynamicPropertiesStore().saveKandyFee(entry.getValue());
          break;
        }
        ...
        case TOTAL_KANDY_LIMIT: {
          manager.getDynamicPropertiesStore().saveTotalKandyLimit(entry.getValue());
          break;
        }
        case ALLOW_LVM_TRANSFER_TRC10: {
          manager.getDynamicPropertiesStore().saveAllowLvmTransferTrc10(entry.getValue());
          break;
        }
        case TOTAL_CURRENT_KANDY_LIMIT: {
          manager.getDynamicPropertiesStore().saveTotalKandyLimit2(entry.getValue());
          break;
        }
        ...
        case ALLOW_ADAPTIVE_KANDY: {
          if (manager.getDynamicPropertiesStore().getAllowAdaptiveKandy() == 0) {
            manager.getDynamicPropertiesStore().saveAllowAdaptiveKandy(entry.getValue());
            if (manager.getChainBaseManager()
              ...
              manager.getDynamicPropertiesStore().saveTotalKandyTargetLimit(
                  manager.getDynamicPropertiesStore().getTotalKandyLimit() / 2880);
        ...
        case ALLOW_LVM_CONSTANTINOPLE: {
          manager.getDynamicPropertiesStore().saveAllowLvmConstantinople(entry.getValue());
          manager.getDynamicPropertiesStore().addSystemContractAndSetPermission(48);
          break;
        }
        case ALLOW_LVM_SOLIDITY_059: {
          manager.getDynamicPropertiesStore().saveAllowLvmSolidity059(entry.getValue());
          break;
        }
        case ADAPTIVE_RESOURCE_LIMIT_TARGET_RATIO: {
          ...
          manager.getDynamicPropertiesStore().saveTotalKandyTargetLimit(
              manager.getDynamicPropertiesStore().getTotalKandyLimit() / ratio);
          break;
        }
        ...
        case ALLOW_LVM_ISTANBUL: {
          manager.getDynamicPropertiesStore().saveAllowLvmIstanbul(entry.getValue());
          break;
        }
        ...
        //   manager.getDynamicPropertiesStore().saveAllowLvmStake(entry.getValue());
        //   break;
        // }
        // case ALLOW_LVM_ASSET_ISSUE: {
        //   manager.getDynamicPropertiesStore().saveAllowLvmAssetIssue(entry.getValue());
        //   break;
        // }

...
//   @Override
//   public void consume(TransactionCapsule usdl, TransactionTrace trace)
//       throws ContractValidateException, AccountResourceInsufficientException,
//       TooBigTransactionResultException {
//     List<Contract> contracts = usdl.getInstance().getRawData().getContractList();
//     if (usdl.getResultSerializedSize() > Constant.MAX_RESULT_SIZE_IN_TX * contracts.size()) {
...
//       bytesSize = usdl.getInstance().toBuilder().clearRet().build().getSerializedSize();
//     } else {
//       bytesSize = usdl.getSerializedSize();
//     }
...
//       logger.debug("usdlId {}, bandwidth cost: {}", usdl.getTransactionId(), bytesSize);
...
//       boolean ret = consumeFeeForCreateNewAccount(accountCapsule, trace);
//       if (!ret) {
//         throw new AccountResourceInsufficientException();
//       }
//   }

...
public class ExchangeCreateActuatorTest {
  ...
  /**
   * SameTokenName close,not usdl,ont token is ok, but the second one is not exist.
   */
  @Test
  ...
  /**
   * SameTokenName open,not usdl,ont token is ok, but the second one is not exist.
   */
  @Test

...
//   private static final int USDL_NUM = 2;
...
//     TransactionCapsule usdl = new TransactionCapsule(transferAssetContract);
...
//     TransactionCapsule usdl = new TransactionCapsule(contract);
...
//     TransactionTrace trace = new TransactionTrace(usdl, StoreFactory
//         .getInstance(), new RuntimeImpl());

//     AccountCapsule ownerCapsuleNew = chainBaseManager.getAccountStore()
//         .get(ByteArray.fromHexString(OWNER_ADDRESS));

//     Assert.assertEquals(122L + (dbManager.getDynamicPropertiesStore().supporlvm()
...
//     Assert.assertEquals(
//         122L + (chainBaseManager.getDynamicPropertiesStore().supporlvm()
//             ? Constant.MAX_RESULT_SIZE_IN_TX : 0),
...
//             + (chainBaseManager.getDynamicPropertiesStore().supporlvm()
...
//     Assert.assertEquals(
//         113L + (chainBaseManager.getDynamicPropertiesStore().supporlvm()
//             ? Constant.MAX_RESULT_SIZE_IN_TX : 0),
...
//     long byteSize = usdl.getInstance().toBuilder().clearRet().build().getSerializedSize()
//         + Constant.MAX_RESULT_SIZE_IN_TX;
...
//     TransactionCapsule usdl = new TransactionCapsule(contract, chainBaseManager.getAccountStore());
//     TransactionTrace trace = new TransactionTrace(usdl, StoreFactory
//         .getInstance(), new RuntimeImpl());

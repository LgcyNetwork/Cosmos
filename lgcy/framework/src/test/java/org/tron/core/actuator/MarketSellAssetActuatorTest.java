...
public class MarketSellAssetActuatorTest {
  ...
  private static final String USDL = "_";
  ...
  /**
   * no Enough Balance For Selling USDL, result is failed, exception is "No enough balance !".
   */
  @Test
  public void noEnoughBalanceForSellingUSDL() {
  ...
  /**
   * no buy orders before,add first sell order,selling USDL and buying token
   */
  @Test
  ...
  /**
   * no buy orders before,add first sell order,selling Token and buying USDL
   */
  @Test

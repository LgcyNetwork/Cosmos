...
public class ManagerTest extends BlockGenerate {
  ...
  public void setBlockReference()
    ...
    TransferContract tc =
        TransferContract.newBuilder()
            ...
            .build();
    TransactionCapsule usdl = new TransactionCapsule(tc, ContractType.TransferContract);
    if (chainManager.getDynamicPropertiesStore().getLatestBlockHeaderNumber() == 0) {
      ...
      chainManager.setBlockReference(usdl);
      Assert.assertEquals(1,
          ByteArray.toInt(usdl.getInstance().getRawData().getRefBlockBytes().toByteArray()));
    }
  ...
  public void pushBlockInvalidMerkelRoot() {
    Transaction usdl = Transaction.newBuilder().build();
    TransactionCapsule moreTrans = new TransactionCapsule(usdl);
  ...
  public void pushBlockTooMuchShieldedTransactions() {
    ShieldContract.ShieldedTransferContract usdl1 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(10)
        .setToAmount(10)
        .build();
    ShieldContract.ShieldedTransferContract usdl2 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(20)
        .setToAmount(20)
        .build();
    TransactionCapsule trans1 = new TransactionCapsule(usdl1, ContractType.ShieldedTransferContract);
    TransactionCapsule trans2 = new TransactionCapsule(usdl2, ContractType.ShieldedTransferContract);

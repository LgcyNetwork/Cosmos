...
public class NodeStatisticsTest {
  ...
  public void testMessage() {
    ...
    InventoryMessage invMsgUSDL =
        new InventoryMessage(new ArrayList<>(), Protocol.Inventory.InventoryType.USDL);
    String inventoryMessageStr = invMsgUSDL.toString();
    Assert.assertNotNull(inventoryMessageStr);
    statistics.addTcpInMessage(invMsgUSDL);
    statistics.addTcpOutMessage(invMsgUSDL);
    ...
    FetchInvDataMessage fetchInvDataUSDL =
        new FetchInvDataMessage(new ArrayList<>(), Protocol.Inventory.InventoryType.USDL);
    statistics.addTcpInMessage(fetchInvDataUSDL);
    statistics.addTcpOutMessage(fetchInvDataUSDL);
    ...
    Assert.assertEquals(1, statistics.tronInUSDLFetchInvData.getTotalCount());
    ...
    Assert.assertEquals(1, statistics.tronInUSDLs.getTotalCount());

...
public class BandWidthRuntimeOutOfTimeWithCheckTest {
  ...
  private String usdl2ContractAddress = "TPMBUANrTwwQAPwShn7ZZjTJz1f3F8jknj";
  ...
  public void testSuccess() {
    try {
      ...
      usdlCap.setResultCode(contractResult.OUT_OF_USDL);
      ...
      Assert.assertEquals(9950000, trace.getReceipt().getKandyUsageTotal());
      Assert.assertEquals(50000, kandy);
      Assert.assertEquals(990000000, balance);
      Assert.assertEquals(9950000 * Constant.SUN_PER_KANDY,
  ...
  private byte[] createContract()
    ...
    Assert.assertEquals(88529 * 100, balance + kandy * 100);

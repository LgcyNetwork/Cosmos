...
@Slf4j
public class KandyWhenSendAndTransferTest {

  private Manager dbManager;
  private TronApplicationContext context;
  private DepositImpl deposit;
  private String dbPath = "output_KandyWhenSendAndTransferTest";
  ...
  public void callValueTest()
    ...
    LVMTestResult result = deployCallValueTestContract(value, feeLimit, consumeUserResourcePercent);

    long expectKandyUsageTotal = 174639;
    ...
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - value - expectKandyUsageTotal * 100);
    ...
    long expectKandyUsageTotal2 = 7370;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal2);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - value - (expectKandyUsageTotal + expectKandyUsageTotal2) * 100);
    ...
    long expectKandyUsageTotal3 = 9459;
  ...
  public void sendTest()
    ...
    long expectKandyUsageTotal = 140194;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    byte[] contractAddress = result.getContractAddress();
    Assert.assertEquals(deposit.getAccount(contractAddress).getBalance(), value);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
    ...
    long expectKandyUsageTotal2 = 7025;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal2);
  ...
  public void transferTest()
    ...
    long expectKandyUsageTotal2 = 7030;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal2);
    Assert.assertEquals(result.getRuntime().getResult().getException(), null);
    Assert.assertEquals(result.getRuntime().getResult().isRevert(), true);
    Assert.assertEquals(deposit.getAccount(contractAddress).getBalance(), value);

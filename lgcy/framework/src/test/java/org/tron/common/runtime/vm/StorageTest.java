...
public class StorageTest extends VMTestBase {
  ...
  */
  ...
  public void contractWriteAndDeleteStorage()
    ...
    Assert.assertNull(result.getRuntime().getRuntimeError());
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), 10855);
    ...
    triggerData = LvmTestUtils.parseAbi("testDelete(uint256)",
    ...
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), 5389);
  }

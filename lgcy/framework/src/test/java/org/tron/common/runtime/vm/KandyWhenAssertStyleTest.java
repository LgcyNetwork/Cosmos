...
public class KandyWhenAssertStyleTest {

  private Manager dbManager;
  private TronApplicationContext context;
  private DepositImpl deposit;
  private String dbPath = "output_KandyWhenAssertStyleTest";
  ...
  public void outOfIndexTest()
    ...
    long expectKandyUsageTotal = 39487;
  ...
  public void bytesNTest()
    ...
    long expectKandyUsageTotal = 31875;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
  ...
  public void divZeroTest()
    ...
    long expectKandyUsageTotal = 27875;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
  ...
  public void shiftByNegativeTest()
    ...
    long expectKandyUsageTotal = 28475;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
  ...
  public void enumTypeTest()
    ...
    long expectKandyUsageTotal = 27475;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
  ...
  public void functionPointerTest()
    ...
    long expectKandyUsageTotal = 30475;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
  ...
  public void assertTest()
    ...
    long expectKandyUsageTotal = 26675;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
  ...
  public void systemPrecompileTest()
    ...
    long expectKandyUsageTotal = 89214;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
  ...
  public void outOfMemTest()
    ...
    long expectKandyUsageTotal = 40487;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();

...
public class KandyWhenRequireStyleTest {

  private Manager dbManager;
  private TronApplicationContext context;
  private DepositImpl deposit;
  private String dbPath = "output_KandyWhenRequireStyleTest";
  ...
  public void throwTest()
    ...
    LVMTestResult result = LvmTestUtils
        .deployContractAndReturnLvmTestResult(contractName, address, ABI, code, value, feeLimit,
            consumeUserResourcePercent, libraryAddressPair, dbManager, null);

    long expectKandyUsageTotal = 26275;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    ...
    long expectKandyUsageTotal2 = 124;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal2);
    ...
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - (expectKandyUsageTotal + expectKandyUsageTotal2) * 100);
  ...
  public void thisFunctionViaMessageCallTest()
    ...
    long expectKandyUsageTotal = 57905;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
    ...
    long expectKandyUsageTotal2 = 5339;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal2);
    Assert.assertEquals(result.getRuntime().getResult().isRevert(), true);
    Assert.assertTrue(result.getRuntime().getResult().getException() == null);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
  ...
  public void thatFunctionViaMessageCallTest()
    ...
    long expectKandyUsageTotal = 97341;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
    ...
    long expectKandyUsageTotal2 = 64125;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal2);
    Assert.assertEquals(result.getRuntime().getResult().isRevert(), true);
    Assert.assertTrue(result.getRuntime().getResult().getException() == null);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
  ...
  public void newContractTest1()
    ...
    long expectKandyUsageTotal = 42687;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
    ...
    long expectKandyUsageTotal2 = feeLimit / 100;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal2);
    // todo: revert should be true!! see later
    Assert.assertEquals(result.getRuntime().getResult().isRevert(), false);
    Assert
        .assertTrue(result.getRuntime().getResult().getException() instanceof OutOfKandyException);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - (expectKandyUsageTotal + expectKandyUsageTotal2) * 100);
  ...
  // }
  //
  // contract testReceiveUSDLWithoutPayableContract {
  //
  //   constructor() {}
  //
  ...
  @Test
  public void receiveUSDLWithoutPayableTest()
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException,
      VMIllegalException {
    ...
    result = LvmTestUtils
        .deployContractAndReturnLvmTestResult(contractName, address, ABI, code, 0, feeLimit,
            consumeUserResourcePercent, libraryAddressPair, dbManager, null);
    byte[] contractAddress = result.getContractAddress();
    long expectKandyUsageTotal2 = 100341;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal2);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - (expectKandyUsageTotal + expectKandyUsageTotal2) * 100);
    /* ====================================================================== */
    ...
    long expectKandyUsageTotal3 = 51833;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal3);
    Assert.assertEquals(result.getRuntime().getResult().isRevert(), true);
    Assert.assertTrue(result.getRuntime().getResult().getException() == null);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(), totalBalance
        - (expectKandyUsageTotal + expectKandyUsageTotal2 + expectKandyUsageTotal3) * 100);
  ...
  public void transferTest()
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException {
    // done in KandyWhenSendAndTransferTest
  ...
  public void revertTest()
    ...
    long expectKandyUsageTotal = 36481;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectKandyUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
    ...
    long expectKandyUsageTotal2 = 146;
    Assert.assertEquals(result.getReceipt().getKandyUsageTotal(), expectKandyUsageTotal2);
    Assert.assertEquals(result.getRuntime().getResult().isRevert(), true);
    Assert.assertTrue(result.getRuntime().getResult().getException() == null);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),

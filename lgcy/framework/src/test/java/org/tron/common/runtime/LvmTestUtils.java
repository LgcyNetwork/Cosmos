...
public class LvmTestUtils {
  ...
  public static byte[] deployContractWholeProcessReturnContractAddress(String contractName,
    ...
    Transaction usdl = generateDeploySmartContractAndGetTransaction(contractName, callerAddress, abi,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);
    processTransactionAndReturnRuntime(usdl, deposit, block);
    return WalletUtil.generateContractAddress(usdl);
  }
  ...
  public static Runtime triggerContractWholeProcessReturnContractAddress(byte[] callerAddress,
    ...
    return processTransactionAndReturnRuntime(usdl, deposit, block);
  }
  ...
  public static Transaction generateDeploySmartContractAndGetTransaction(String contractName,
    ...
    TransactionCapsule usdlCapWithoutFeeLimit = new TransactionCapsule(contract,
        ContractType.CreateSmartContract);
    Transaction.Builder transactionBuilder = usdlCapWithoutFeeLimit.getInstance().toBuilder();

    Transaction.raw.Builder rawBuilder = usdlCapWithoutFeeLimit.getInstance().getRawData()
        .toBuilder();
    rawBuilder.setFeeLimit(feeLimit);
    transactionBuilder.setRawData(rawBuilder);
    Transaction usdl = transactionBuilder.build();
    return usdl;
  }
  ...
  public static Transaction generateDeploySmartContractWithCreatorKandyLimitAndGetTransaction(
      String contractName,
      byte[] callerAddress,
      String abi, String code, long value, long feeLimit, long consumeUserResourcePercent,
      String libraryAddressPair, long creatorKandyLimit) {

    CreateSmartContract contract = buildCreateSmartContractWithCreatorKandyLimit(contractName,
        callerAddress, abi, code,
        value, consumeUserResourcePercent, libraryAddressPair, creatorKandyLimit);
    TransactionCapsule usdlCapWithoutFeeLimit = new TransactionCapsule(contract,
        ContractType.CreateSmartContract);
    Transaction.Builder transactionBuilder = usdlCapWithoutFeeLimit.getInstance().toBuilder();
    Transaction.raw.Builder rawBuilder = usdlCapWithoutFeeLimit.getInstance().getRawData()
  ...
  public static Runtime processTransactionAndReturnRuntime(Transaction usdl,
      Deposit deposit, BlockCapsule block)
      throws ContractExeException, ContractValidateException,
      ReceiptCheckErrException, VMIllegalException {
    TransactionCapsule usdlCap = new TransactionCapsule(usdl);
    deposit.commit();
  ...
  public static TransactionTrace processTransactionAndReturnTrace(Transaction usdl,
  ...
  public static LVMTestResult deployContractAndReturnLvmTestResult(String contractName,
    ...
    return processTransactionAndReturnLvmTestResult(usdl, dbManager, blockCap)
        .setContractAddress(WalletUtil.generateContractAddress(usdl));
  }

  public static LVMTestResult deployContractWithCreatorKandyLimitAndReturnLvmTestResult(
      String contractName,
      byte[] callerAddress,
      String abi, String code, long value, long feeLimit, long consumeUserResourcePercent,
      String libraryAddressPair, Manager dbManager, BlockCapsule blockCap, long creatorKandyLimit)
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    Transaction usdl = generateDeploySmartContractWithCreatorKandyLimitAndGetTransaction(
        contractName, callerAddress, abi,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair, creatorKandyLimit);
  ...
  public static LVMTestResult processTransactionAndReturnLvmTestResult(Transaction usdl,
    ...
    trace.setResult();
    return new LVMTestResult(trace.getRuntime(), trace.getReceipt(), null);
  }
  ...
  public static CreateSmartContract buildCreateSmartContract(String contractName,
    ...
    builder.setOriginKandyLimit(engeryLimit);
  ...
  public static CreateSmartContract buildCreateSmartContractWithCreatorKandyLimit(
      String contractName,
      byte[] address,
      String abiString, String code, long value, long consumeUserResourcePercent,
      String libraryAddressPair, long creatorKandyLimit) {
    ...
    builder.setAbi(abi);
    builder.setConsumeUserResourcePercent(consumeUserResourcePercent);
    builder.setOriginKandyLimit(creatorKandyLimit);

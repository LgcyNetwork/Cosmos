...
public class Create2Test extends VMTestBase {
  ...
  */
  ...
  public void testCreate2()
    ...
    manager.getDynamicPropertiesStore().saveAllowLvmIstanbul(0);
...
contract A {
  ...
  public void create2AddressTest() throws ContractExeException, ReceiptCheckErrException,
    ...
    manager.getDynamicPropertiesStore().saveAllowLvmTransferTrc10(1);
    manager.getDynamicPropertiesStore().saveAllowLvmConstantinople(1);
    manager.getDynamicPropertiesStore().saveAllowLvmSolidity059(1);
    manager.getDynamicPropertiesStore().saveAllowLvmIstanbul(1);
    String contractName = "Factory_0";
    byte[] address = Hex.decode(OWNER_ADDRESS);
    String abi = "[]";

...
public class Constant {
  ...
  public static final byte ADD_PRE_FIX_BYTE_MAINNET = (byte) 0x30;   //41 + address
  ...
  public static final long PB_DEFAULT_KANDY_LIMIT = 0L;
  public static final long CREATOR_DEFAULT_KANDY_LIMIT = 1000 * 10_000L;
  ...
  public static final String NODE_NET_MAX_USDL_PER_SECOND = "node.netMaxUSDLPerSecond";
  ...
  public static final String COMMITTEE_ALLOW_ADAPTIVE_KANDY = "committee.allowAdaptiveKandy";
  ...
  public static final String COMMITTEE_ALLOW_LVM_TRANSFER_TRC10 = "committee.allowLvmTransferTrc10";

  public static final String COMMITTEE_ALLOW_LVM_CONSTANTINOPLE = "committee.allowLvmConstantinople";

  public static final String COMMITTEE_ALLOW_LVM_SOLIDITY059 = "committee.allowLvmSolidity059";
  ...
  public static final String USDL_REFERENCE_BLOCK = "usdl.reference.block";

  public static final String USDL_EXPIRATION_TIME_IN_MILLIS_SECONDS = "usdl.expiration.timeInMilliseconds";

  public static final String NODE_RPC_MIN_EFFECTIVE_CONNECTION = "node.rpc.minEffectiveConnection";

  public static final String KANDY_LIMIT_BLOCK_NUM = "enery.limit.block.num";
  ...
  public static final String COMMITTEE_ALLOW_LVM_ISTANBUL = "committee"
      + ".allowLvmIstanbul";
  ...
  public static final String COMMITTEE_ALLOW_LVM_STAKE = "committee.allowLvmStake";

  public static final String COMMITTEE_ALLOW_LVM_ASSETISSUE = "committee.allowLvmAssetIssue";

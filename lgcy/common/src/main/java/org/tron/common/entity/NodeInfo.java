...
public class NodeInfo {
  ...
  public Protocol.NodeInfo transferToProtoEntity() {
    ...
    if (configNodeInfo != null) {
      ...
      configBuilder.setAllowAdaptiveKandy(configNodeInfo.getAllowAdaptiveKandy());
  ...
  public static class ConfigNodeInfo {
    ...
    private long allowAdaptiveKandy;
    ...
    public long getAllowAdaptiveKandy() {
      return allowAdaptiveKandy;
    }

    public ConfigNodeInfo setAllowAdaptiveKandy(long allowAdaptiveKandy) {
      this.allowAdaptiveKandy = allowAdaptiveKandy;
      return this;
    }

...
public class MessageCall {
  ...
  /**
   * kandy to pay for the call, remaining kandy will be refunded to the caller
   */
  private final DataWord kandy;
  /**
  ...
  public MessageCall(OpCode type, DataWord kandy, DataWord codeAddress,
  ...
  public MessageCall(OpCode type, DataWord kandy, DataWord codeAddress,
    ...
    this(type, kandy, codeAddress, endowment, inDataOffs, inDataSize, tokenId, isTokenTransferMsg);

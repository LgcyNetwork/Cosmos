...
public class AssetIssueActuator extends AbstractActuator {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (dynamicStore.getAllowSameTokenName() != 0) {
      ...
      if (("usdl").equals(name)) {
        throw new ContractValidateException("assetName can't be usdl");
      }
    }
    ...
    if (assetIssueContract.getUsdlNum() <= 0) {
      throw new ContractValidateException("USDLNum must greater than 0!");
    }

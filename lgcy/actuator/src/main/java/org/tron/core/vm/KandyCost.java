...
public class KandyCost {

  private static KandyCost instance = null;
  ...
  private final int GENESISKANDYLIMIT = 1000000;
  private final int MINKANDYLIMIT = 125000;
  ...
  private final int LOG_KANDY = 375;
  private final int LOG_DATA_KANDY = 8;
  private final int LOG_TOPIC_KANDY = 375;
  private final int COPY_KANDY = 3;
  private final int EXP_KANDY = 10;
  private final int EXP_BYTE_KANDY = 10;
  ...
  public static KandyCost getInstance() {
    if (instance == null) {
      instance = new KandyCost();
    }
  ...
  public int getGENESISKANDYLIMIT() {
    return GENESISKANDYLIMIT;
  }

  public int getMINKANDYLIMIT() {
    return MINKANDYLIMIT;
  }
  ...
  public int getLOG_KANDY() {
    return LOG_KANDY;
  }

  public int getLOG_DATA_KANDY() {
    return LOG_DATA_KANDY;
  }

  public int getLOG_TOPIC_KANDY() {
    return LOG_TOPIC_KANDY;
  }

  public int getCOPY_KANDY() {
    return COPY_KANDY;
  }

  public int getEXP_KANDY() {
    return EXP_KANDY;
  }

  public int getEXP_BYTE_KANDY() {
    return EXP_BYTE_KANDY;
  }

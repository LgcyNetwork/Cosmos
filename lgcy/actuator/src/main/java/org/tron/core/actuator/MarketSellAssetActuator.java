...
public class MarketSellAssetActuator extends AbstractActuator {
  ...
  private void matchSingleOrder(MarketOrderCapsule takerOrderCapsule,
    ...
    // for makerPrice,sellToken is A,buyToken is USDL.
    // for takerPrice,buyToken is A,sellToken is USDL.

    // makerSellTokenQuantity_A/makerBuyTokenQuantity_USDL =
    //   takerBuyTokenQuantityCurrent_A/takerSellTokenQuantityRemain_USDL
    // => takerBuyTokenQuantityCurrent_A = takerSellTokenQuantityRemain_USDL *
    //   makerSellTokenQuantity_A/makerBuyTokenQuantity_USDL
    ...
    if (takerBuyTokenQuantityRemain == makerOrderCapsule.getSellTokenQuantityRemain()) {
      ...
      // makerSellTokenQuantityRemain_A/makerBuyTokenQuantityCurrent_USDL =
      //   makerSellTokenQuantity_A/makerBuyTokenQuantity_USDL
      // => makerBuyTokenQuantityCurrent_USDL = makerSellTokenQuantityRemain_A *
      //   makerBuyTokenQuantity_USDL / makerSellTokenQuantity_A
    ...
    addUSDLOrToken(takerOrderCapsule, takerBuyTokenQuantityReceive, takerAccountCapsule);
    addUSDLOrToken(makerOrderCapsule, makerBuyTokenQuantityReceive);
  ...
  // for taker
  private void addUSDLOrToken(MarketOrderCapsule orderCapsule, long num,

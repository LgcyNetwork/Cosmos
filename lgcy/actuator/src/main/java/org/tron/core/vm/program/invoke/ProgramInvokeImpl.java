...
public class ProgramInvokeImpl implements ProgramInvoke {
  ...
  public ProgramInvokeImpl(DataWord address, DataWord origin, DataWord caller, DataWord balance,
      ...
      long vmStartInUs, long vmShouldEndInUs, long kandyLimit) {
  ...
  public ProgramInvokeImpl(byte[] address, byte[] origin, byte[] caller, long balance,
      ...
      long vmStartInUs, long vmShouldEndInUs, boolean byTestingSuite, long kandyLimit) {
    this(address, origin, caller, balance, callValue, tokenValue, tokenId, msgData, lastHash,
        coinbase,
        timestamp, number, deposit, vmStartInUs, vmShouldEndInUs, kandyLimit);
    this.byTestingSuite = byTestingSuite;
  }
  ...
  public ProgramInvokeImpl(byte[] address, byte[] origin, byte[] caller, long balance,
      ...
      long number, Repository deposit, long vmStartInUs, long vmShouldEndInUs, long kandyLimit) {

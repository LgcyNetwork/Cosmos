...
public class RepositoryImpl implements Repository {
  ...
  public long calculateGlobalKandyLimit(AccountCapsule accountCapsule) {
    ...
    long kandyWeight = frozeBalance / 1_000_000L;
    long totalKandyLimit = getDynamicPropertiesStore().getTotalKandyCurrentLimit();
    long totalKandyWeight = getDynamicPropertiesStore().getTotalKandyWeight();

...
public class ProgramInvokeMockImpl implements ProgramInvoke {
  ...
  /*           KANDYPRICE op       */
  public DataWord getMinKandyPrice() {
    byte[] minKandyPrice = Hex.decode("09184e72a000");
    return new DataWord(minKandyPrice);
  }
  ...
  public void setKandyLimit(long customizedKandyLimit) {
    kandyLimit = customizedKandyLimit;
  }

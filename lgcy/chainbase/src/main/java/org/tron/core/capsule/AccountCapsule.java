...
public class AccountCapsule implements ProtoCapsule<Account>, Comparable<AccountCapsule> {
  ...
  public long getAcquiredDelegatedFrozenBalanceForKandy() {
    return getAccountResource().getAcquiredDelegatedFrozenBalanceForKandy();
  }

  public void setAcquiredDelegatedFrozenBalanceForKandy(long balance) {
    AccountResource newAccountResource = getAccountResource().toBuilder()
        .setAcquiredDelegatedFrozenBalanceForKandy(balance).build();
  ...
  public long getDelegatedFrozenBalanceForKandy() {
    return getAccountResource().getDelegatedFrozenBalanceForKandy();
  }

  public void addAcquiredDelegatedFrozenBalanceForKandy(long balance) {
    AccountResource newAccountResource = getAccountResource().toBuilder()
        .setAcquiredDelegatedFrozenBalanceForKandy(
            getAccountResource().getAcquiredDelegatedFrozenBalanceForKandy() + balance).build();;
  ...
  public void addDelegatedFrozenBalanceForKandy(long balance) {
    AccountResource newAccountResource = getAccountResource().toBuilder()
        .setDelegatedFrozenBalanceForKandy(getAccountResource().getDelegatedFrozenBalanceForKandy() + balance).build();
  ...
  public long getTronPower() {
    ...
    tp += account.getAccountResource().getFrozenBalanceForPower().getFrozenBalance();
    tp += account.getAccountResource().getDelegatedFrozenBalanceForKandy();
    return tp;
  }
  ...
  public void setFrozenForKandy(long newFrozenBalanceForKandy, long time) {
    Frozen newFrozenForKandy = Frozen.newBuilder()
        .setFrozenBalance(newFrozenBalanceForKandy)
        .setExpireTime(time)
        .build();

    AccountResource newAccountResource = getAccountResource().toBuilder()
        .setFrozenBalanceForPower(newFrozenForKandy).build();
  ...
  public long getKandyFrozenBalance() {
    return this.account.getAccountResource().getFrozenBalanceForPower().getFrozenBalance();
  }

  public long getKandyUsage() {
    return this.account.getAccountResource().getKandyUsage();
  }

  public void setKandyUsage(long kandyUsage) {
    this.account = this.account.toBuilder()
        .setAccountResource(
            this.account.getAccountResource().toBuilder().setKandyUsage(kandyUsage).build())
        .build();
  }

  public long getAllFrozenBalanceForKandy() {
    return getKandyFrozenBalance() + getAcquiredDelegatedFrozenBalanceForKandy();
  }

  public long getLatestConsumeTimeForPower() {
    return this.account.getAccountResource().getLatestConsumeTimeForPower();
  }

  public void setLatestConsumeTimeForPower(long latest_time) {
    this.account = this.account.toBuilder()
        .setAccountResource(
            this.account.getAccountResource().toBuilder().setLatestConsumeTimeForPower(latest_time)
                .build()).build();
  }
  ...
  public void clearDelegatedResource() {
    ...
    AccountResource newAccountResource = getAccountResource().toBuilder()
        .setAcquiredDelegatedFrozenBalanceForKandy(0L).build();

...
public class ProgramResult {
  ...
  public void spendKandy(long kandy) {
    kandyUsed += kandy;
  }
  ...
  public void refundKandy(long kandy) {
    kandyUsed -= kandy;
  }
  ...
  public void addCallCreate(byte[] data, byte[] destination, byte[] kandyLimit, byte[] value) {
    getCallCreateList().add(new CallCreate(data, destination, kandyLimit, value));
  }
  ...
  public void addFutureRefund(long kandyValue) {
    futureRefund += kandyValue;
  }

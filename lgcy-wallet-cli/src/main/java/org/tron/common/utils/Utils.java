...
public class Utils {
  ...
  public static byte[] generateContractAddress(Transaction usdl, byte[] ownerAddress) {
    // get tx hash
              ...
              try {
                ...
                switch (contract.getType()) {
                  ...
                  case ExchangeTransactionContract:
                    ...
                    break;
                  case UpdateKandyLimitContract:
                    UpdateKandyLimitContract updateKandyLimitContract =
                        contractParameter.unpack(UpdateKandyLimitContract.class);
                    contractJson =
                        JSONObject.parseObject(
                            JsonFormat.printToString(updateKandyLimitContract, selfType));
                    break;

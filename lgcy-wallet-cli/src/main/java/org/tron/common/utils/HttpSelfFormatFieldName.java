...
public class HttpSelfFormatFieldName {
  ...
  static {
    ...
    //UpdateKandyLimitContract
    AddressFieldNameMap.put("protocol.UpdateKandyLimitContract.owner_address", 1);
    AddressFieldNameMap.put("protocol.UpdateKandyLimitContract.contract_address", 1);
    //ClearABIContract

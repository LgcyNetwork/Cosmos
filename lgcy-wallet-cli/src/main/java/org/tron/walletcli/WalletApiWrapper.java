...
//      System.out.println("Warning: GetAddress failed,  Please login first !!");
  ...
  public boolean assetIssue(byte[] ownerAddress, String name, String abbrName, long totalSupply,
    ...
    if (usdlNum <= 0) {
      System.out.println("usdlNum should greater than 0. but really is " + usdlNum);
      return false;
    }
    builder.setUsdlNum(usdlNum);
  ...
  public boolean updateKandyLimit(byte[] ownerAddress, byte[] contractAddress,
    ...
    return wallet.updateKandyLimit(ownerAddress, contractAddress, originKandyLimit);
  }
  ...
  public boolean deployContract(byte[] ownerAddress, String name, String abiStr, String codeStr,
      long feeLimit, long value, long consumeUserResourcePercent, long originKandyLimit,
    ...
    return wallet
        .deployContract(ownerAddress, name, abiStr, codeStr, feeLimit, value,
            ...
            originKandyLimit, tokenValue, tokenId,
  ...
  public boolean sendShieldedCoin(String fromAddress, long fromAmount, List<Long> shieldedInputList,
    ...
    if (shieldedInputList.size() > 0) {
      ...
      for (int i = 0; i < shieldedInputList.size(); ++i) {
        ...
        outPointBuild.setHash(ByteString.copyFrom(ByteArray.fromHexString(noteInfo.getUsdlId())));
      ...
      for (int i = 0; i < shieldedInputList.size(); ++i) {
        ...
        System.out.println("usdlId " + noteInfo.getUsdlId());
